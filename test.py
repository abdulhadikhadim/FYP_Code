...
if __name__ == "__main__":
    ...
    """ Dataset """
    dataset_path = "D:\zip512\DataSet640\Data"
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_y)):
        ...
        if np.sum(mask) == 0 and np.sum(y_pred) == 0:
            f1_value = 1.0  # Set F1 score to 1.0 when no true positive samples
            jac_value = 1.0  # Set Jaccard score to 1.0 when no true positive samples
        else:
